...
<div class="bg-white rounded-xl shadow-lg p-6 lg:p-8">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-500 mt-1 text-lg">
                You'll fill in each category's checklist after saving.
            </p>
        </div>
    ...
    <form method="POST" action="{{ route('building-inspections.store') }}">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="building_in_charge" value="{{ old('building_in_charge') }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            ...
            <div>
                ...
                <input type="date" name="inspection_date" value="{{ old('inspection_date', now()->toDateString()) }}"
                    class="w-full border rounded-lg p-4" required>
            </div>

            <div>
                <label class="block mb-2 font-semibold">Noted By (optional)</label>
                <input type="text" name="noted_by" value="{{ old('noted_by') }}"
                    placeholder="e.g. PPS Director's name"
                    class="w-full border rounded-lg p-4">
            </div>
