        ...
        <div class="flex justify-between h-16">
            <div class="flex">
             ...
             <!-- Navigation Links -->
                ...
                <!-- Notification Bell -->
            <div class="hidden sm:flex sm:items-center sm:me-3" x-data="{ openNotif: false }">
                <!-- Bell Button -->
                ...
                <div x-show="openNotif"
                    ...
                    class="absolute right-0 mt-12 w-80 bg-white rounded-lg shadow-lg z-50">
                    ...
                    <div id="notif-list" class="max-h-60 overflow-y-auto">
                        <p class="p-3 text-gray-500 text-sm">
    ...
    <script>
        async function loadNotifications() {
            ...
            if (!data.notifications || data.notifications.length === 0) {
                list.innerHTML = `<p class="p-3 text-gray-500 text-sm">📭 No notifications yet</p>`;
                return;
            }
            ...
            data.notifications.forEach(notif => {
                list.innerHTML += `
                    <div onclick="handleNotification(${notif.id}, '${notif.type}', this)"
                        class="p-3 border-b cursor-pointer hover:bg-gray-100 ${notif.is_read ? 'bg-white' : 'bg-gray-100'}">
